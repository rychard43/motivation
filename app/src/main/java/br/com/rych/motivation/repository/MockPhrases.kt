package br.com.rych.motivation.repository
...
class MockPhrases {
    ...
    private val ALL = Constants.PHASEFILTER.ALL
    private val HAPPY = Constants.PHASEFILTER.HAPPY
    private val MORNING = Constants.PHASEFILTER.MORNING
